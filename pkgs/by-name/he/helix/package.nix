...
rustPlatform.buildRustPackage (
  ...
  let
    ...
    # Dynamic libraries for the grammars always use the `.so` extension, also on Darwin
    # See here: https://github.com/helix-editor/helix/blob/master/helix-loader/src/grammar.rs
